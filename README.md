...
## How to use
1. BROM Pictures uses two third-party Python modules: NumPy, MatPlotLib . These need to be installed to run script.
To draw the output of BROM model you should add ascii ouput file into the same folder with cloned repository 
The easiest way is to use Enthought Canopy(https://store.enthought.com/downloads/#default). Epress version is free and it is enough powerful to run this script. 
