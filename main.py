...
#ax11.plot(kz[1],depth,'g-',kz[1],depth,'g-')
plt.grid(True)
...
ax12.plot(sal[numday], depth, 'r-',sal[numday], depth, 'r-')
#ax12.xaxis.set_ticks_position('top') # this moves the ticks to the top
ax12.set_xlim([salmin, salmax])
ax12.set_xticks(np.arange(salmin,salmax+((salmax -salmin)/2.),((salmax -salmin)/2.)))
...
ax13.plot(temp[numday],depth,'b-',temp[numday],depth,'b-')
#ax13.xaxis.set_ticks_position('top') # this moves the ticks to the top
ax13.set_xlim([tempmin,tempmax])
ax13.set_xticks(np.arange(tempmin,tempmax+((tempmax - tempmin)/2.),((tempmax - tempmin)/2.)))
...
#Fig1 Water - 2/1 SO4
ax21 = ax2.twiny()
ax21.plot(so4[numday],depth,'g-',so4[numday],depth,'g-')
...
ax22.plot(s0[numday],depth,'r-',s0[numday],depth,'r-')
...
ax23.plot(h2s[numday], depth, 'b-',h2s[numday], depth, 'b-')
...
ax24.plot(s2o3[numday], depth, 'm-',s2o3[numday], depth, 'm-')
...
ax31.plot(o2[numday], depth, 'g-',o2[numday], depth, 'g-')
...
ax32.plot(nh4[numday],depth,'r-',nh4[numday],depth,'r-')
...
ax33.plot(no2[numday], depth, 'b-',no2[numday], depth, 'b-')
...
ax34.plot(no3[numday], depth, 'm-',no3[numday], depth, 'm-')
...
#Fig1 Water -  4/1 MnII
ax41 = ax4.twiny()
ax41.plot(mn2[numday],depth,'g-',mn2[numday],depth,'g-')
...
ax42.plot(mn3[numday],depth,'r-',mn3[numday],depth,'r-')
...
ax43.plot(mn4[numday], depth, 'b-',mn4[numday], depth, 'b-')
...
ax44.plot(mns[numday], depth, 'm-',mns[numday], depth, 'm-')
...
ax45.plot(mnco3[numday], depth, 'c-',mnco3[numday], depth, 'c-')
...
axn31.plot(po4[numday], depth, 'g-',po4[numday], depth, 'g-')
...
axn32.plot(pon[numday],depth,'r-',pon[numday],depth,'r-')
...
axn33.plot(don[numday], depth, 'b-',don[numday], depth, 'b-')
...
axn41.plot(fe2[numday],depth,'g-',fe2[numday],depth,'g-')
...
axn42.plot(fe3[numday],depth,'r-',fe3[numday],depth,'r-')
...
axn43.plot(fes[numday], depth, 'b-',fes[numday], depth, 'b-')
...
axn44.plot(fes2[numday], depth, 'm-',fes2[numday], depth, 'm-')
...
ax5.plot(temp[numday],depth,'bo-',temp[numday],depth,'bo-')
ax5.set_ylabel('Depth (m)')
plt.setp(ax5.get_xticklabels(), visible=False)
ax5.set_xlim([tempmin,tempmax])
ax5.set_xticks(np.arange(tempmin,tempmax+((tempmax - tempmin)/2.),((tempmax - tempmin)/2.)))
ax5.set_ylim([y2max, y2min])
#Fig1 BBL 1/2 - Salinity
ax52 = ax5.twiny()
ax52.plot(sal[numday], depth, 'ro-',sal[numday], depth, 'ro-')
...
plt.text(1.1, 0.3,'BBL ', fontweight='bold', #Write number of day to Figure
    ...
    transform=ax6.transAxes)
#Fig1  BBL - SO4
ax6.plot(so4[numday],depth,'go-',so4[numday],depth,'go-')
...
#Fig1 BBL -  2/2 S0
ax62 = ax6.twiny()
ax62.plot(s0[numday], depth, 'ro-',s0[numday], depth, 'ro-')
...
#Fig1 BBL -  2/2 h2S
ax63 = ax6.twiny()
ax63.plot(h2s[numday], depth, 'bo-',h2s[numday], depth, 'bo-')
...
#Fig1 BBL -  2/2 s2o3
ax64 = ax6.twiny()
ax64.plot(s2o3[numday], depth, 'mo-',s2o3[numday], depth, 'mo-')
...
#Fig1 BBL 3/2 - o2
ax7.plot(o2[numday],depth,'go-',o2[numday],depth,'go-')
...
#Fig1 BBL 3/2 - nh4
ax72 = ax7.twiny()
ax72.plot(nh4[numday], depth, 'ro-',nh4[numday], depth, 'ro-')
...
#Fig1 BBL 3\2 - no2
ax73 = ax7.twiny()
ax73.plot(no2[numday], depth, 'b-',no2[numday], depth, 'b-')
...
#Fig1 BBL - 3/2 NO3
ax74 = ax7.twiny()
ax74.plot(no3[numday], depth, 'mo-',no3[numday], depth, 'mo-')
...
#Fig1 BBL - 4/2 - Mn II
ax8.plot(mn2[numday],depth,'go-',mn2[numday],depth,'go-')
...
#Fig1 BBL 3/2 - PO4
axn7.plot(po4[numday],depth,'go-',po4[numday],depth,'go-')
...
#Fig1  3/2 - PON
axn72 = axn7.twiny()
axn72.plot(pon[numday], depth, 'ro-',pon[numday], depth, 'ro-')
...
#Fig1 BBL 3\2 - don
axn73 = axn7.twiny()
axn73.plot(don[numday], depth, 'b-',don[numday], depth, 'b-')
...
#Fig1 BBL - 4/2 - Fe II
axn8.plot(fe2[numday],depth,'go-',fe2[numday],depth,'go-')
...
ax92.plot(sal[numday], depth_sed, 'ro-',sal[numday], depth_sed, 'ro-')
ax92.xaxis.set_ticks_position('top') # this moves the ticks to the top
ax92.set_xlim([sed_salmin, sed_salmax])
ax92.set_xticks(np.arange(sed_salmin,sed_salmax+((sed_salmax -sed_salmin)/2.),((sed_salmax -sed_salmin)/2.)))
...
ax93.plot(temp[numday],depth_sed,'bo-',temp[numday],depth_sed,'bo-')
ax93.xaxis.set_ticks_position('top') # this moves the ticks to the top
ax93.set_xlim([tempmin, tempmax])
ax93.set_xticks(np.arange(tempmin,tempmax+((tempmax - tempmin)/2.),((tempmax - tempmin)/2.)))
...
ax101 = ax10.twiny()
ax101.plot(so4[numday],depth_sed,'go-',so4[numday],depth_sed,'go-')
...
ax102.plot(s0[numday],depth_sed,'ro-',s0[numday],depth_sed,'ro-')
...
ax103.plot(h2s[numday], depth_sed, 'bo-',h2s[numday], depth_sed, 'bo-')
...
ax104.plot(s2o3[numday], depth_sed, 'mo-',s2o3[numday], depth_sed, 'mo-')
...
ax111.plot(o2[numday],depth_sed,'go-',o2[numday],depth_sed,'go-')
...
ax112.plot(nh4[numday],depth_sed,'ro-',nh4[numday],depth_sed,'ro-')
...
ax113.plot(no2[numday], depth_sed, 'bo-',no2[numday], depth_sed, 'bo-')
...
ax114.plot(no3[numday], depth_sed, 'mo-',no3[numday], depth_sed, 'mo-')
...
ax121 = ax12n.twiny()
ax121.plot(mn2[numday],depth_sed,'go-',mn2[numday],depth_sed,'go-')
...
ax122.plot(mn3[numday],depth_sed,'ro-',mn3[numday],depth_sed,'ro-')
...
ax123.plot(mn4[numday], depth_sed, 'bo-',mn4[numday], depth_sed, 'bo-')
...
ax124.plot(mns[numday], depth_sed, 'mo-',mns[numday], depth_sed, 'mo-')
...
ax125.plot(mnco3[numday], depth_sed, 'co-',mnco3[numday], depth_sed, 'co-')
...
axn111.plot(po4[numday],depth_sed,'go-',po4[numday],depth_sed,'go-')
...
axn112.plot(pon[numday],depth_sed,'ro-',pon[numday],depth_sed,'ro-')
...
axn113.plot(don[numday], depth_sed, 'bo-',don[numday], depth_sed, 'bo-')
...
#Sediment - 4/3 FeII
axn121 = axn12n.twiny()
axn121.plot(fe2[numday],depth_sed,'go-',fe2[numday],depth_sed,'go-')
...
axn122.plot(fe3[numday],depth_sed,'ro-',fe3[numday],depth_sed,'ro-')
...
axn123.plot(fes[numday],depth_sed, 'bo-',fes[numday],depth_sed, 'bo-')
...
axn124.plot(fes2[numday],depth_sed, 'mo-',fes2[numday],depth_sed, 'mo-')
...
ax11.spines['top'].set_position(('outward', axis1))
ax11.spines['top'].set_color('g')
ax11.plot(phy[numday], depth, 'g-',phy[numday], depth, 'g-')
...
ax12.spines['top'].set_position(('outward', axis2))
ax12.spines['top'].set_color('r')
ax12.plot(het[numday], depth, 'r-',het[numday], depth, 'r-')
ax12.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
ax21.spines['top'].set_position(('outward', axis1)) #move
ax21.spines['top'].set_color('g')
ax21.plot(baan[numday],depth,'g-',baan[numday],depth,'g-')
...
ax22.spines['top'].set_position(('outward', axis2))
ax22.spines['top'].set_color('r')
ax22.plot(bhan[numday],depth,'r-',bhan[numday],depth,'r-')
ax22.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
ax23.spines['top'].set_position(('outward', axis3))
ax23.spines['top'].set_color('b')
ax23.plot(bhae[numday], depth, 'b-',bhae[numday], depth, 'b-')
...
ax24.spines['top'].set_position(('outward', axis4))
ax24.spines['top'].set_color('m')
ax24.plot(baae[numday], depth, 'm-',baae[numday], depth, 'm-')
ax24.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
axn11.plot(ph[numday], depth, 'b-',ph[numday], depth, 'b-')
...
axn12.plot(pco2[numday], depth, 'r-',pco2[numday], depth, 'r-')
...
axn21.plot(alk[numday],depth,'g-',alk[numday],depth,'g-')
...
axn22.plot(dic[numday],depth,'m-',dic[numday],depth,'m-')
...
axn31.plot(ch4[numday], depth, 'b-',ch4[numday], depth, 'b-')
...
axn32.spines['top'].set_position(('outward', axis2))
axn32.spines['top'].set_color('r')
axn32.plot(om_ar[numday],depth,'r-',om_ar[numday],depth,'r-')
axn32.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
axn41.plot(si[numday],depth,'g-',si[numday],depth,'g-')
...
axn42.plot(si_part[numday],depth,'m-',si_part[numday],depth,'m-')
axn42.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
#Fig2  BBL 1/2 - Phyto
ax5 = plt.subplot(gs[6])
ax5.plot(phy[numday],depth,'go-',phy[numday],depth,'go-')
ax5.set_ylabel('Depth (m)')
plt.setp(ax5.get_xticklabels(), visible=False)
...
#Fig2 BBL 1/2 - Het
ax52 = ax5.twiny()
ax52.plot(het[numday], depth, 'ro-',het[numday], depth, 'ro-')
...
#Fig2  BBL - Baan
ax6.plot(baan[numday],depth,'go-',baan[numday],depth,'go-')
...
#Fig2 BBL -  2/2 Bhan
ax62 = ax6.twiny()
ax62.plot(bhan[numday], depth, 'ro-',bhan[numday], depth, 'ro-')
...
#Fig2 BBL -  2/2 Bhae
ax63 = ax6.twiny()
ax63.plot(bhae[numday], depth, 'bo-',bhae[numday], depth, 'bo-')
...
#Fig2 BBL -  2/2 Baae
ax64 = ax6.twiny()
ax64.plot(baae[numday], depth, 'mo-',baae[numday], depth, 'mo-')
...
axn5.plot(ph[numday],depth,'bo-',ph[numday],depth,'bo-')
...
#fig 2 BBL 1/2 - pco2
axn52 = axn5.twiny()
axn52.plot(pco2[numday], depth, 'ro-',pco2[numday], depth, 'ro-')
...
#fig2  BBL - alk
axn6.plot(alk[numday],depth,'go-',alk[numday],depth,'go-')
...
#fig2 BBL -  2/2 dic
axn62 = axn6.twiny()
axn62.plot(dic[numday], depth, 'mo-',dic[numday], depth, 'mo-')
...
#fig2 BBL 3/2 - ch4
axn7.plot(ch4[numday],depth,'bo-',ch4[numday],depth,'bo-')
plt.setp(axn7.get_xticklabels(), visible=False)
axn7.set_xlim([0,ch4max])
axn7.set_ylim([y2max, y2min])
#fig 2  BBL 3/2 - om_ar
axn72 = axn7.twiny()
axn72.plot(om_ar[numday], depth, 'ro-',om_ar[numday], depth, 'ro-')
...
#fig2 BBL - 4/2 - Si
axn8.plot(si[numday],depth,'go-',si[numday],depth,'go-')
plt.setp(axn8.get_xticklabels(), visible=False)
...
axn82 = axn8.twiny()
axn82.plot(si_part[numday], depth, 'mo-',si_part[numday], depth, 'mo-')
...
ax91.spines['top'].set_position(('outward', axis1))
ax91.spines['top'].set_color('g')
ax91.plot(phy[numday], depth_sed, 'go-',phy[numday], depth_sed, 'go-')
ax91.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
ax92.spines['top'].set_position(('outward', axis2))
ax92.spines['top'].set_color('r')
ax92.plot(het[numday], depth_sed, 'ro-',het[numday], depth_sed, 'ro-')
ax92.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
ax101.spines['top'].set_position(('outward', axis1))
ax101.spines['top'].set_color('g')
ax101.plot(baan[numday],depth_sed,'go-',baan[numday],depth_sed,'go-')
...
ax102.spines['top'].set_position(('outward', axis2))
ax102.spines['top'].set_color('r')
ax102.plot(bhan[numday],depth_sed,'ro-',bhan[numday],depth_sed,'ro-')
ax102.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
ax103.spines['top'].set_position(('outward', axis3))
ax103.spines['top'].set_color('b')
ax103.plot(bhae[numday], depth_sed, 'bo-',bhae[numday], depth_sed, 'bo-')
ax103.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
ax104.spines['top'].set_position(('outward', axis4))
ax104.spines['top'].set_color('m')
ax104.plot(baae[numday], depth_sed, 'mo-',baae[numday], depth, 'mo-')
ax104.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
axn91.plot(ph[numday], depth_sed, 'bo-',ph[numday], depth_sed, 'bo-')
...
axn92.plot(pco2[numday], depth_sed, 'ro-',pco2[numday], depth_sed, 'ro-')
...
axn101.plot(alk[numday],depth_sed,'go-',alk[numday],depth_sed,'go-')
...
axn102.plot(dic[numday],depth_sed,'mo-',dic[numday],depth_sed,'mo-')
...
axn111.plot(ch4[numday],depth_sed,'bo-',ch4[numday],depth_sed,'bo-')
...
axn112.spines['top'].set_position(('outward', axis2))
axn112.spines['top'].set_color('r')
axn112.plot(om_ar[numday],depth_sed,'ro-',om_ar[numday],depth_sed,'ro-')
axn112.xaxis.set_ticks_position('top') # this moves the ticks to the top
...
axn121 = axn12n.twiny()
axn121.plot(si[numday],depth_sed,'go-',si[numday],depth_sed,'go-')
for spinename, spine in axn121.spines.iteritems():
    if spinename != 'top':
        spine.set_visible(False)
axn121.spines['top'].set_position(('outward', axis1))
...
axn122.plot(si_part[numday],depth_sed,'mo-',si_part[numday],depth_sed,'mo-')
axn122.xaxis.set_label_position('top') # this moves the label to the top
